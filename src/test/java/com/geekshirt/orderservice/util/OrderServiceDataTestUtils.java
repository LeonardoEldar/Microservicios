...
import com.geekshirt.orderservice.utils.CurrencyType;
...
public class OrderServiceDataTestUtils {
    ...
    public static AccountDto getMockAccount() {
    ...
    private static PaymentDetailsDto getMockPaymentDetailsDto(AccountDto accountDto) {
        CreditCardDto cardDetails = accountDto.getCreditCard();
    ...
    public static PaymentRequest getMockPaymentRequest(AccountDto accountDto) {
        return PaymentRequest.builder()
                .payment(getMockPaymentDetailsDto(accountDto))
                .accountId("1")
                .amount(1000)
                .orderId("5")
